...
\emph{Results pending prototype implementation. Tables will be populated with PPL, NIAH, and QuALITY metrics for each configuration above.}
...
\begin{tabular}{lccc}
\toprule
\textbf{Config} & \textbf{PPL} & \textbf{NIAH (\%)} & \textbf{QuALITY (\%)} \\
\midrule
Baseline (FP16) & TBD & TBD & TBD \\
Uniform \texttt{q4\_0} & TBD & TBD & TBD \\
PCA-adaptive (4-bit avg) & TBD & TBD & TBD \\
WHT + uniform (TurboQuant) & TBD & TBD & TBD \\
PCA + adaptive & TBD & TBD & TBD \\
AM $2\times$ + PCA-Quant & TBD & TBD & TBD \\
\bottomrule
\end{tabular}
\caption{Main results across all configurations. TBD: awaiting prototype results.}
