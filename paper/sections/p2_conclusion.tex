...
\begin{enumerate}
    ...
    \item \textbf{Theory matches experiment.} On TinyLlama-1.1B at 4-bit average, PCA-Quant reduces PPL degradation by 51\% compared to uniform quantization at the same memory footprint. The measured error reduction (51.6\% cosine, 51.2\% PPL) matches the theoretical prediction from the AM/GM coding gain ($G = 1.97$, $\Delta b = +0.49$ bits).
